...
export default function SelectCountry(props) {
    const { formData, isError, updateFormData, updateError } = props
    
    const handleCountry = (evt, country) => {
        updateFormData(null,true,country)
    }
    return (
        <Autocomplete
            size='small'
            ...
            renderOption={(props, option) => (
                <Box
                    component="li" 
                    sx={{ '& > img': { mr: 2, flexShrink: 0 , fontFamily: "'Lexend Deca', sans-serif"} }}  {...props} >
                    <img
                        loading="lazy"
                        width="20"
                        ...
                        alt=""
                    />
                    <StyledB className="font">{option.label} ({option.code}) +{option.phone}</StyledB>
